...
export interface IColumnPropsMobile {
  listId: string;
  listIdModel: string;
  title: string;
  Created: string;
  solicit: string;
  textButton: string;
  textButtonMobileSolicit: string;
  textButtonMobileSolicit2: string;
...
export const getColumnsMobile = (props: IColumnPropsMobile): IColumn[] => {
  return [
    {
      key: "column1",
      name: `${props.title}`,
          ...
          case "Rascunho":
            return (
              <div style={{ marginTop: "-8px" }}>
                ...
                >
                <p className={styles.ptext}>{props.textButtonMobileSolicit}<br/> {props.textButtonMobileSolicit2}</p>  
                </DefaultButton>
              </div>
            );
        }
